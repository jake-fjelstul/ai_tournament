...
class PlayerAgent:
    def __init__(self, board, transition_matrix, time_left_func):
        ...
        self.last_opp_pos = board.opponent_worker.position
    ...
    def play(self, board: 'Board', sensor_data: Tuple, time_left: Callable):
        try:
            ...
            if sensor_data is not None:
                ...
                curr_opp_pos = board.opponent_worker.position
                if curr_opp_pos != self.last_opp_pos:
                    self.opp_belief.infer_movement_bias(self.last_opp_pos, curr_opp_pos)
                self.last_opp_pos = curr_opp_pos
