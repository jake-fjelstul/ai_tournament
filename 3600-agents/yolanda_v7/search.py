    ...
    if is_max:
        ...
        for move in ordered_moves:
            ...
            if move.move_type.name == 'SEARCH':
                ...
                # Only predict (diffuse the rat) if a turn actually passed where the rat moved
                new_belief.predict()
            
            eval_val, _ = minimax(child, new_belief, cell_potential, depth - 1, alpha, beta, not is_max, deadline)
