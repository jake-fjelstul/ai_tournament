...
def all_legal_moves(board: Board, belief: RatBelief = None) -> List[Move]:
    spatial_moves = carpet_rolls(board) + prime_steps(board) + plain_steps(board)
    
    # If completely trapped, burn a turn with a search to survive
